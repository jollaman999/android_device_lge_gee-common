...
PRODUCT_COPY_FILES += \
	device/lge/gee-common/wifi/prima/WCNSS_cfg.dat:system/vendor/firmware/wlan/prima/WCNSS_cfg.dat \
	device/lge/gee-common/wifi/p2p_supplicant.conf:system/etc/wifi/p2p_supplicant.conf \
